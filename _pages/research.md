...
{% assign status_order = "Peer-Reviewed Publication,Forthcoming,Under Review,Working Paper,Work in Progress,Other Writing" | split: "," %}
...
<details open>
<summary class="research-category">Temporary Migration</summary>
...
<details>
<summary class="research-category">Racial Categorization</summary>
<p class="research-description">Under construction.</p>
{% for status in status_order %}
...
<details>
<summary class="research-category">Asian America</summary>
<p class="research-description">Under construction.</p>
{% for status in status_order %}
